...
void CHands::Precache(void)
{
	...
	m_usHands = PRECACHE_EVENT(1, "events/crowbar.sc");
}
...
BOOL CHands::Deploy()
{
	int ret = DefaultDeploy("models/v_hands.mdl", "models/p_hands.mdl", CROWBAR_DRAW, "hands"); EMIT_SOUND(ENT(m_pPlayer->pev), CHAN_ITEM, "weapons/katana_draw.wav", 1, ATTN_NORM);
	return ret;
}
